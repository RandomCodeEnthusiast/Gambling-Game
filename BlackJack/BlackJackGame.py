...
def BlackJackGame() :
    ...
    from InventoryManagement.MoneyManagement.money import gain,Money
    from project import projectpath
    from InventoryManagement.BackUpSystem.BackUp import FileWriter
...
def ScoreCalc(DrawnValue, CardDrawn, Score: int, PlayerPosition):
    ...
    from InventoryManagement.BackUpSystem.BackUp import FileOpener
...
def SaveAces(PlayerPosition: int, Aces: int):
    from InventoryManagement.BackUpSystem.BackUp import FileOpener, FileWriter
    from project import projectpath
